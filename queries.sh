...
echo  "$($PSQL "SELECT DISTINCT year, name FROM teams INNER JOIN games ON teams.team_id = games.winner_id WHERE teams.team_id = games.winner_id AND round = 'Final' ORDER BY year")"
